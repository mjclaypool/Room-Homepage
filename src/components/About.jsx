...
export default function About() {
  return (
    <div className="flex flex-col lg:flex-row w-full font-spartan">
      <img src={darkImg} alt="About images of a showroom" className="lg:w-[30%] object-cover" />
      <div className="lg:w-[40%] px-7 lg:px-9 py-12 lg:py-4 my-auto">
        <h2 className="text-lg lg:text-xl font-bold text-primary-black mb-3 tracking-[0.25em]">ABOUT OUR FURNITURE</h2>
      ...
      <img src={lightImg} alt="About images of a single chair" className="lg:w-[30%] object-cover" />
    </div>
  )
}